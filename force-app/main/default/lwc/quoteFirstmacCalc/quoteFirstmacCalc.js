    ...
    handleSave(event, saveType) {
        ...
        if (!this.messageObj.errors.length > 0 || this.isErrorInsuranceOnly()) {
            ...
            CalHelper.saveQuote(loanType, this.quoteForm, this.recordId)
                .then((data) => {
                    console.log("@@data in handleSave:", JSON.stringify(this.quoteForm, null, 2));
                    console.log("mess OBJ:", JSON.stringify(this.messageObj, null, 2));
                    // save buttons validation
                    this.messageObj = Validations.validateSaving(this.quoteForm, loanType);
