...
import { CalHelper } from "./c1FinanceCalcHelper";
...
export default class C1FinanceCalc extends LightningElement {
    ...
    get termOptions() {
        if (this.quoteForm.loanTypeDetail === "Standard" || this.quoteForm.loanTypeDetail === "Lite") {
            ...
            return CalHelper.options.terms.slice(0, 3);
        } else {
    ...
    //DOF and Max DOF
    dofCalc() {
        this.quoteForm.dof = CalHelper.getDOFCalc(this.quoteForm, this.isFullDofCalc);
    }
