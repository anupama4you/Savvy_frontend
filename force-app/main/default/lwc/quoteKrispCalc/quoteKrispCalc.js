...
export default class QuoteKrispCalc extends LightningElement {
  ...
  get riskFeeTotal() {
    console.log(
      "risk fee total >> " + CalHelper.getRiskFee(this.quoteForm)
    );
    this.quoteForm.riskFeeTotal = CalHelper.getRiskFee(this.quoteForm);
    return CalHelper.getRiskFee(this.quoteForm);
  }
