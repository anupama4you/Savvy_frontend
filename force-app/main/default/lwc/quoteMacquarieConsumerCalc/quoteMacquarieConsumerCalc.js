...
export default class QuoteMacquarieConsumerCalc extends LightningElement {
    ...
    handleCalculate(event) {
        try {
            ...
            CalHelper.calculate(this.quoteForm)
              ...
              .catch((error) => {
                console.error(`error from QuoteMacquarieConsumerCalc ${error}`);
                this.messageObj = error.messages;
                QuoteCommons.fieldErrorHandler(this, this.messageObj.errors);
                console.error(
                  "quoteMacquarieConsumerCalc.js: get errors -- ",
