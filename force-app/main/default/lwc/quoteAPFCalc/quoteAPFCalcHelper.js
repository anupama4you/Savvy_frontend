import getQuotingData from "@salesforce/apex/QuoteAPFController.getQuotingData";
import calculateRepayments from "@salesforce/apex/QuoteController.calculateAllRepayments";
import sendQuote from "@salesforce/apex/QuoteController.sendQuote";
import save from "@salesforce/apex/QuoteAPFController.save";
import {
    QuoteCommons,
    CommonOptions,
...
const getLoadAmount = (quote) => {
    const { price } = quote;
    const netDeposit = CalHelper.getNetDeposit(quote);
    return ((price || 0) - netDeposit);
};
