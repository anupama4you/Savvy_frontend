...
import { CalHelper } from "./quoteSelfcoCalcHelper";
import LENDER_LOGO from "@salesforce/resourceUrl/SelfcoLogo";
...
export default class QuoteSelfcoCalc extends LightningElement {
    isBusy;
    isBaseRateBusy;
    isCalculated = false;
    ...
    get tierOptions() {
        return CalHelper.options.tierOptions;
    }
    ...
    handleFieldChange(event) {
        ...
        if (fldName === "privateSales") {
            this.quoteForm['applicationFee'] = CalHelper.getApplicationFee(v);
        }
