import getQuotingData from "@salesforce/apex/QuoteSelfcoCalcController.getQuotingData";
import getBaseRates from "@salesforce/apex/QuoteController.getBaseRates";
import calculateRepayments from "@salesforce/apex/QuoteController.calculateRepayments";
import sendQuote from "@salesforce/apex/QuoteController.sendQuote";
import save from "@salesforce/apex/QuoteSelfcoCalcController.save";
import {
  QuoteCommons,
  CommonOptions,
...
const calcOptions = {
  ...
  assetTypes: [
    { label: "Tier 1 - Auto", value: "Tier 1 - Auto" },
    { label: "Tier 2 - Trucks/Medical equip", value: "Tier 2 - Trucks/Medical equip" },
    { label: "Tier 3 - Office /IT/Solar", value: "Tier 3 - Office /IT/Solar" },
    { label: "Tier 4 - Fitouts", value: "Tier 4 - Fitouts" },
  ],
  clientTiers: [
    { label: "A", value: "A" },
    { label: "B", value: "B" },
  ...
  vehicleAges: assetAgeOptions(1, 24),
  typeValues: [
  ...
  terms: CommonOptions.terms(0, 72).map(({ label, value }) => ({ label: label.toString(), value: value.toString() })),
};
...
const reset = (recordId) => {
  let r = {
    ...
    tier: calcOptions.tierOptions[0].value,
    privateSales: calcOptions.privateSales[0].value,
    paymentType: calcOptions.paymentTypes[1].value,
...
const getApplicationFee = (appFee) => {
  if ('Y' === appFee) {
