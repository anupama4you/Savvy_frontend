...
const calcOptions = {
  ...
  creditScores: [
    { label: "751-1200", value: "751-1200" },
    { label: "551-750", value: "551-750" },
    { label: "451-550", value: "451-550" },
    { label: "< 450", value: "< 450" },
    { label: "BFS Plus", value: "BFS Plus" }
  ],
  assetTypes: [
    { label: "Car", value: "Car" },
...
const reset = (recordId) => {
  let r = {
    ...
    propertyOwner: CommonOptions.yesNo[1].value,
  ...
  new Promise((resolve, reject) => {
    ...
    getQuotingData({
      ...
      .then((quoteData) => {
        ...
        // Opp
        console.log(`credit score:`, quoteData.opp.Credit_Score__c);
        if (quoteData.opp && quoteData.opp.Credit_Score__c > 0) {
          if (data.creditScore !== "BFS Plus") {
            const cs = quoteData.opp.Credit_Score__c;
            if (cs > 750) {
              data.creditScore = calcOptions.creditScores[0].value;
            } else if (cs > 550) {
              data.creditScore = calcOptions.creditScores[1].value;
            } else if (cs > 450) {
              data.creditScore = calcOptions.creditScores[2].value;
            } else if (cs <= 450) {
              data.creditScore = calcOptions.creditScores[3].value;
            }
          }
        }
