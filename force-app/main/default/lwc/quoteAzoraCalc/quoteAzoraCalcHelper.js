...
const calculate = (quote) =>
    new Promise((resolve, reject) => {
        ...
        // Validate quote
        res.messages = Validations.validate(quote, res.messages, { settings: lenderSettings});
        console.log("🚀 ~ file: quoteAzoraCalcHelper.js ~ line 76 ~ newPromise ~ res.messages", JSON.stringify(res.messages, null, 2));
