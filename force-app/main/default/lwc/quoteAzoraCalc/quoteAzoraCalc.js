...
// import CREDIT_FIELD from "@salesforce/schema/Azora_Rates__c.Credit_Score__c";
import OPPNAME_FIELD from "@salesforce/schema/Custom_Opportunity__c.Name";
import { getRecord, getFieldValue } from "lightning/uiRecordApi";

const fields = [FNAME_FIELD, LNAME_FIELD, OPPNAME_FIELD];

export default class QuoteAzoraCalc extends LightningElement {
    ...
    connectedCallback() {
        ...
        CalHelper.load(this.recordId)
            .then((data) => {
                ...
                this.creditScoreOptions = data.score;
            })
            .catch((error) => {
    ...
    get riskFeeMax() {
        let riskFeeMax = null;
        if (this.quoteForm.creditScore && this.tableRates) {
            riskFeeMax = this.findCreditObj(this.tableRates, this.quoteForm.creditScore).Risk_Fee__c;
            this.quoteForm.maxLoan = this.findCreditObj(this.tableRates, this.quoteForm.creditScore).Max_Loan__c;
            this.quoteForm.riskFeeTotal = riskFeeMax;
        }
        return riskFeeMax;
    };

    clientRate(creditScore, tableRates) {
        let cRate;
        creditScore && tableRates && (cRate = this.findCreditObj(tableRates, creditScore).Rate__c);
        return cRate;
    }
    ...
    get creditScoreOptions() {
        return this.creditScoreOptions;
    }


    get repaymentTypeOptions() {
    ...
    handleFieldChange(event) {
        ...
        if (fldName === "creditScore") {
            this.quoteForm.clientRate = this.clientRate(this.quoteForm.creditScore, this.tableRates);
        }
    }
