...
const getQuotingPageName = (calcName) => {
  ...
  if (calcName) {
    ...
    } else if (calcName === "Multipli") {
      pageName = "PARTNER_QT_Multipli__c";
    } else if (calcName === "Scotpac Asset") {
      pageName = "PARTNER_QT_Scotpac_Asset__c";
    } else if (calcName === "Thorn") {
      pageName = "PARTNER_QT_Thorn__c";
    }
  }
