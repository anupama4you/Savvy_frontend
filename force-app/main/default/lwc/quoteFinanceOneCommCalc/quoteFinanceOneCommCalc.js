...
export default class QuoteFinanceOneCommCalc extends LightningElement {
    ...
    //Commission
    commissionCalc() {
        console.log('commission::', JSON.stringify(this.quoteForm, null, 2));
        CalHelper.getFOCommission(this.quoteForm)
            .then((data) => {
              const c = this.quoteForm.commission;
              this.quoteForm.commission = data;
              console.log("commission::", this.quoteForm.commission);
              if (c != this.quoteForm.commission) {
                // Insurances
                QuoteCommons.calculateInsurances(this, "price");
                // --------------
              }
            })
            .catch((error) => {
