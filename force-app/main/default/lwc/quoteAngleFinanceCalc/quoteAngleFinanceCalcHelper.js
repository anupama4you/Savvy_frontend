import getQuotingData from "@salesforce/apex/QuoteAngleFinanceCalcController.getQuotingData";
import getBaseRates from "@salesforce/apex/QuoteController.getBaseRates";
import calculateRepayments from "@salesforce/apex/QuoteController.calculateRepayments";
import { QuoteCommons, CommonOptions } from "c/quoteCommons";
import { Validations } from "./quoteValidations";
import sendQuote from "@salesforce/apex/QuoteController.sendQuote";
import save from "@salesforce/apex/QuoteAngleFinanceCalcController.save";
...
const LENDER_QUOTING = "Angle Finance";
  ...
  new Promise((resolve, reject) => {
    ...
    getBaseRates({
      ...
      .then((rates) => {
        ...
        resolve({
          baseRate: rates.baseRate !== undefined? rates.baseRate : null,
        });
      })
      .catch((error) => reject(error));
  });
